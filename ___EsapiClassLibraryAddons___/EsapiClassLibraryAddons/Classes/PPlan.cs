namespace VMS.TPS
{
	...
	public class PPlan
	{
        ...
        public static PPlan CreatePPlan(ScriptContext context, PlanSetup plan)
		{
			...
			if (plan.UniqueFractionation.NumberOfFractions != null)
			{
				p.fractions = (double)plan.UniqueFractionation.NumberOfFractions;
			}
			//}
            ...
            try
            {
				...
				p.dosePerFraction = plan.UniqueFractionation.PrescribedDosePerFraction.Dose;
        ...
        public static PPlan CreatePPlan(ScriptContext context, PlanSum sum)
        {
            ...
            foreach (var ps in p.pSetups)
            {
                ...
                var fxTuple = Tuple.Create((int)ps.UniqueFractionation.NumberOfFractions, ps.UniqueFractionation.PrescribedDosePerFraction.Dose);
            ...
            try
            {
                ...
                //p.dosePerFraction = p.pSetup.UniqueFractionation.PrescribedDosePerFraction.Dose;
                //p.rxDose = (double)(p.dosePerFraction * p.fractions);
            }
            catch
            {
        ...
        //    {
        //        p.type = "Plan";
        //        p.pSetup = context.PlanSetup;
        //        p.pItem = (PlanningItem)context.PlanSetup;
        //        p.structureSet = context.PlanSetup?.StructureSet;
        //        p.id = context.PlanSetup.Id.ToString().Replace(" ", "_").Replace(":", "_");
        //        if (context.PlanSetup.UniqueFractionation.NumberOfFractions != null)
        //        {
        //            p.fractions = (double)context.PlanSetup.UniqueFractionation.NumberOfFractions;
        //        }
        //    }
        ...
        //        if (p.pSetup.Dose != null)
        //        {
        //            p.maxDose = Math.Round(p.pSetup.Dose.DoseMax3D.Dose, 5);
        //        }
        //        else { p.maxDose = Double.NaN; }
        //        p.dosePerFraction = p.pSetup.UniqueFractionation.PrescribedDosePerFraction.Dose;
        //        p.rxDose = (double)(p.dosePerFraction * p.fractions);
        ...
        //    p.course = context.PlanSetup.Course;
        //    p.approvalStatus = context.PlanSetup.ApprovalStatus;
        //    p.beams = context.PlanSetup.Beams;
