            ...
            try
            {
                ...
                foreach (var plan in mainEsjo.pPlanListValue)
                {
                    ...
                    if (plan.Type == "Plan")
                    {
                        ...
                        if (plan.PSetup.UniqueFractionation.NumberOfFractions.HasValue)
                        {
                            ESJO planNumberOfFractions = ESJO.CreateESJO("Fractions", plan.DosePerFraction); planJOList.Add(planNumberOfFractions);
                        }
                        else
                        {
